...
```
$ export ENCRYPTION_KEY=$(python3 -c 'import os,binascii; print(binascii.hexlify(os.urandom(32)).decode())')
...
To trace DNS TX/RX packets, set `CHASHELL_DNS_TRACE=1` in the environment (works without `TAGS=debug`).
